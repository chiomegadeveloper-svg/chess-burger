# Start here: v9 release

Read [UPDATE-V9.md](UPDATE-V9.md) for the current features, setup, tests and device limitations. Version 8 notes remain available for the earlier Supabase schema and owner setup.
