...
export const BOARD_THEMES: BoardTheme[] = [
  ...
  { id: "bubble-gum", name: "Bubble Gum", group: "theme", light: "#ffe3e5", dark: "#f176a4", frame: "#d52670", accent: "#ff9fc3" },
  ...
  { id: "jungle", name: "Jungle", group: "theme", light: "#e5d3a0", dark: "#45764a", frame: "#315036", accent: "#b2dc70" },
