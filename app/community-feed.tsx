              ...
              {!announcement && (
                <span className="feed-identity-badges">
                  ...
                  {event.guild_name && (event.guild_logo_url ? (
                    ...
                    <span className="feed-guild-logo feed-guild-initial" role="img" aria-label={`${event.guild_name} guild logo`}>
                      {event.guild_name.charAt(0)}
                    </span>
                  ))}
                </span>
              )}
              <div className="feed-copy">
                ...
                <p>
                  {announcement ? (
                    ...
                    >
                      {event.display_name}
                      {event.guild_name && <span className="feed-guild-name"> of {event.guild_name}</span>}
                    </button>
                  )}
