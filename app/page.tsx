...
export default function Page(){
 ...
 function rateLocal(result:'win'|'loss'|'draw',gameId:string){
  ...
  const rated=applyResult({...localRating},result),offlineDelta=result==='win'?2:result==='loss'?-Math.min(5,localRating.cbr):0;rated.cbr=Math.max(0,localRating.cbr+offlineDelta);rated.rating_delta=offlineDelta;
